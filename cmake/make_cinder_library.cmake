...
function( ci_make_library )
    set( oneValueArgs LIBRARY_NAME CINDER_PATH ASSETS_PATH )
    ...
    set( CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${ARG_LIBRARY_NAME} )

    ci_log_v( "LIBRARY_NAME: ${ARG_LIBRARY_NAME}" )
        ...
        if( blockName )
            ...
            if( TARGET "${blockName}" )
                ...
                if( ${blockName}_INCLUDES )
                    target_include_directories( ${ARG_LIBRARY_NAME} PUBLIC ${${blockName}_INCLUDES} )
                endif()
                if( ${blockName}_LIBRARIES )
                    target_link_libraries( ${ARG_LIBRARY_NAME} ${${blockName}_LIBRARIES} )
                endif()
            endif()
    ...
    if( CINDER_MAC )
        ...
        set_target_properties( ${ARG_LIBRARY_NAME} PROPERTIES
                MACOSX_BUNDLE_BUNDLE_NAME ${ARG_LIBRARY_NAME}
